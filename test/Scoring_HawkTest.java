...
class Scoring_HawkTest {
    ...
    public void hawk_scoring_A() {
        ...
        b[2][5] = new Board("F", "F", 6);
        b[3][4] = new Board("F", "H", 6);
        b[3][3] = new Board("F", "S", 6);

        // Should equal 0 since 2 hawks are touching
        b[0][0] = new Board("F", "h", 6);
        b[1][0] = new Board("F", "h", 6);

        // Should equal 1 because hawk is on its own
        b[0][6] = new Board("F", "h", 6);
        b[0][7] = new Board("F", "b", 6);
        b[1][6] = new Board("F", "B", 6);
    ...
    public void hawk_scoring_C() {
        ...
        b[4][5] = new Board("F", "h", 6);
        b[5][5] = new Board("F", "h", 6);

        // Should equal 0 because it has no line of sights
        b[5][0] = new Board("F", "h", 6);
