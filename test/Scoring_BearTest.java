...
class Scoring_BearTest
{
    ...
    public void bear_scorecard_A() {
        ...
        b1[0][1] = new Board("F", "b", 6);
        b1[0][3] = new Board("F", "b", 6);
        b1[0][4] = new Board("F", "b", 6);
        b1[1][1] = new Board("F", "b", 6);
        b1[1][2] = new Board("F", "E", 6);
        b1[1][3] = new Board("F", "H", 6);
        b1[2][3] = new Board("F", "b", 6);
        b1[2][4] = new Board("F", "b", 6);
        ...
        b2 = b1;
        b2[2][0] = new Board("F", "b", 6);
        b2[2][1] = new Board("F", "S", 6);
        b2[3][0] = new Board("F", "b", 6);
        b2[4][0] = new Board("F", "b", 6);
        b2[4][1] = new Board("F", "E", 6);
        b2[4][2] = new Board("F", "b", 6);
        b2[4][3] = new Board("F", "F", 6);
        b2[4][4] = new Board("F", "b", 6);
    ...
    public void bear_scorecard_B() {
        ...
        b2[0][1] = new Board("F", "b", 6);
        b2[0][3] = new Board("F", "b", 6);
        b2[0][4] = new Board("F", "b", 6);
        b2[1][0] = new Board("F", "b", 6);
        b2[1][1] = new Board("F", "b", 6);
        b2[1][2] = new Board("F", "E", 6);
        b2[1][4] = new Board("F", "b", 6);
        b2[2][1] = new Board("F", "F", 6);
        b2[3][1] = new Board("F", "b", 6);
        b2[3][2] = new Board("F", "b", 6);
        b2[3][3] = new Board("F", "b", 6);
        ...
        b1[0][0] = new Board("F", "b", 6);
        b1[0][1] = new Board("F", "b", 6);
        b1[0][2] = new Board("F", "b", 6);
        b1[0][4] = new Board("F", "b", 6);
        b1[1][0] = new Board("F", "b", 6);
        b1[1][4] = new Board("F", "b", 6);
        b1[2][1] = new Board("F", "S", 6);
        b1[2][2] = new Board("F", "b", 6);
        b1[2][3] = new Board("F", "b", 6);
        b1[2][4] = new Board("F", "E", 6);
        b1[3][0] = new Board("F", "b", 6);
        b1[3][2] = new Board("F", "b", 6);
    ...
    public void bear_scorecard_C() {
        ...
        b1[0][0] = new Board("F", "b", 6);
        b1[0][1] = new Board("F", "b", 6);
        b1[0][3] = new Board("F", "H", 6);
        b1[0][4] = new Board("F", "b", 6);
        b1[1][0] = new Board("F", "b", 6);
        b1[1][2] = new Board("F", "b", 6);
        b1[1][4] = new Board("F", "b", 6);
        b1[2][1] = new Board("F", "H", 6);
        b1[2][2] = new Board("F", "b", 6);
        b1[3][1] = new Board("F", "b", 6);

        Board.print_boards(b1, 6, 4, 1);
        int bear_score = Scoring_Setup.scoring_setups(b1, 1,  scoring_cards);
        assertEquals(21, bear_score);   // two groups of 3 + group of 2

        b2[0][0] = new Board("F", "b", 6);
        b2[0][1] = new Board("F", "b", 6);
        b2[0][2] = new Board("F", "S", 6);
        b2[0][4] = new Board("F", "b", 6);
        b2[0][5] = new Board("F", "b", 6);
        b2[1][0] = new Board("F", "b", 6);
        b2[1][2] = new Board("F", "b", 6);
        b2[1][3] = new Board("F", "E", 6);
